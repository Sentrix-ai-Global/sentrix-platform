    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 900, color: "#fff", margin: 0 }}>{al.title}</h1>
        </div>
              ...
              <div style={{ paddingLeft: 10 }}>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 10, flexWrap: "wrap", gap: 8 }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4, flexWrap: "wrap" }}>
                      <span style={{ fontSize: 15, fontWeight: 900, color: "#fff" }}>{alert.title}</span>
                      <span style={{ padding: "3px 10px", borderRadius: 20, fontSize: 12, fontWeight: 900, background: cfg.bg, color: cfg.color, border: `1px solid ${cfg.border}` }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap", marginTop: 10 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    <span style={{ fontSize: 13, color: "#4a6080" }}>{alert.region}</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
